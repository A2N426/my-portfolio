            ...
            <div className="text-white lg:w-[50%]">
                <div className="mt-4" data-aos="zoom-in-right">
                    ...
                    <div className="flex lg:gap-5 gap-2">
                        <a href="https://chef-recipes-hunter.web.app/" className="bg-[#f3004b] lg:w-auto text-center w-1/3 py-1 lg:px-4 font-semibold hover:bg-white lg:py-2 hover:text-[#f3004b] hover:scale-105 duration-100">Live Site</a>
                        <a href="https://github.com/A2N426/world-great-recipes-client" className="bg-[#f3004b] lg:w-auto text-center w-1/3 py-1 lg:px-4 font-semibold hover:bg-white lg:py-2 hover:text-[#f3004b] hover:scale-105 duration-100">Github Client</a>
                        <a href="https://github.com/A2N426/world-great-recipes-server" className="bg-[#f3004b] lg:w-auto text-center w-1/3 py-1 lg:px-4 font-semibold hover:bg-white lg:py-2 hover:text-[#f3004b] hover:scale-105 duration-100">Github Server</a>
                    </div>
                </div>
            </div>
